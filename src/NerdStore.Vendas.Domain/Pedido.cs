...
namespace NerdStore.Vendas.Domain
{
    public class Pedido : Entity, IAggregateRoot
    {
        ...
        private readonly List<PedidoItem> _pedidoItens; // serve para manipular os itens
        private IReadOnlyCollection<PedidoItem> PedidoItens => _pedidoItens; // lista externa somente leitura
        ...
        {
            return _pedidoItens.Any(predicate => predicate.ProdutoId == item.ProdutoId);
        }
        ...
        public static class PedidoFactory // classe aninhada
        {
